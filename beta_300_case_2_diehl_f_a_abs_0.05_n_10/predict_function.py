...
class VariantCoeLinear1d(torch.nn.Module):
    ...
    def f_real(self, u):
        c =[-0.9295, -0.6586, -0.2325,  0.1398,  0.3702,  0.4351,  0.3750,  0.2558, 0.1305,  0.0742,  0.0695]
    ...
    def a_real(self, u):
        ...
        c = [-0.0837, -0.1649, -0.0895, -0.3282, -0.1738, -0.2018, -0.3456,  0.0521, 0.3771, -0.0916, -0.1002]
        outputs = u.unsqueeze(1)
        outputs = outputs.permute(0, 2, 1)
...
if __name__ == "__main__":
    experiment_name = 'beta_300_case_2_0.05_diehl'
