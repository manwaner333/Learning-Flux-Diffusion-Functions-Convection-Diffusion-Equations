...
def a_predict_function(u):
    if u <= 0.25:
        y = (-0.006071397616176388)*u+(-0.00032391229573025044)*1
    elif u > 0.25 and u < 0.5:
        y = (-0.0717747968286389)*u+(-0.00684008223891581)*1
    elif u >= 0.5 and u < 0.75:
        y = (0.8201464892252324)*1+(0.2819484212037965)*u
    else:
        y = (0.737559828017336)*u+(0.693917064081347)*1
    return np.abs(y)
...
if __name__ == "__main__":
    ...
    test_data_name = 'beta_10_case_1_0.05'
