...
class VariantCoeLinear1d(torch.nn.Module):
    ...
    def f_real(self, u):
        c =[-0.9318, -0.6751, -0.2213,  0.1445,  0.3644,  0.4342,  0.3845,  0.2564, 0.1333,  0.0727,  0.0676]
    ...
    def a_real(self, u):
        ...
        c = [0.0091, -0.0077,  0.0015, -0.0008,  0.1062,  0.0011, -0.1077,  0.0764, 0.4618, -0.4247, -0.3801]
...
if __name__ == "__main__":
    experiment_name = 'beta_300_case_2_N_200_0.5_diehl'
