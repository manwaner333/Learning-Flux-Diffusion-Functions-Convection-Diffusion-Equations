...
class VariantCoeLinear1d(torch.nn.Module):
    ...
    def f_real(self, u):
        c =[-0.9357, -0.6516, -0.2366,  0.1399,  0.3710,  0.4455,  0.3986,  0.2627, 0.1232,  0.0593,  0.0532]
    ...
    def a_real(self, u):
        ...
        c = [-0.0865, -0.1681, -0.0662, -0.3089, -0.1723, -0.2125, -0.3563,  0.0566, 0.3912, -0.0923, -0.1030]
    ...
    def update(self):
        ...
        if max_f_prime > 0.0 and max_f_prime < 25.0 and amax > 0.0 and amax < 0.5:
...
if __name__ == "__main__":
    experiment_name = 'beta_300_case_1_0.05_diehl'
