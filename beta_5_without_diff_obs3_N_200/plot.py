...
def f_predict_function(u):
    a = (0.7997162183267026)*u+(-0.7863379574176251)*1+(0.0482739356482541)*u**2+(0.003859978687646674)*u**3+(7.112473517102447e-05)*u**4+(3.027304981117351e-06)*u**5
    b = (0.6749082669419904)*u+(0.537155674574929)*1+(0.020871751283416434)*u**2+(0.0020178841048064757)*u**3+(1.3652829271437038e-05)*u**4+(-5.203304044787792e-06)*u**5
    return a/b
...
if __name__ == "__main__":
    ...
    test_data_name = 'beta_5_case_3_N_200_0.0_example_7'
    ...
    real_time_step = 209    # 168(1.5)   # 223 (2.0)
    predict_time_step = 209   # 165(1.5)   # 219 (2.0)
    time = 20
    example_index = 0
