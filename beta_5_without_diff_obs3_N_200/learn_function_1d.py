...
options = {
    '--device': 'cpu',  # 'cuda:0',
    '--precision': 'double',
    '--taskdescriptor': 'beta_5_case_3_N_200_0.0_example_7',
...
for l in [layer]:
    ...
    xopt, f, d = lbfgsb(nfi.f, nfi.flat_param, nfi.fprime, m=500, callback=callback, factr=1e0, pgtol=1e-16, maxiter=maxiter, iprint=1, disp=2)
    nfi.flat_param = xopt
