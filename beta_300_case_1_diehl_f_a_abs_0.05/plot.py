...
def a_predict_function(u):
    c = [-0.1905,  0.0106, -1.5254, -1.4510, -0.9098,  0.0267]
    if -0.2 < u <= 0:
        res = c[0] * psi_0_l(u)
    elif 0 < u <= 0.2:
...
def f_predict_function(u):
    c = [-0.9148, -0.1929,  0.4061,  0.4170,  0.1377,  0.0877]
    if -0.2 < u <= 0:
        res = c[0] * psi_0_l_f(u)
    elif 0 < u <= 0.2:
        res = c[0] * psi_0_r_f(u) + c[1] * psi_1_l_f(u)
    elif 0.2 < u <= 0.4:
        res = c[1] * psi_1_r_f(u) + c[2] * psi_2_l_f(u)
    elif 0.4 < u <= 0.6:
        res = c[2] * psi_2_r_f(u) + c[3] * psi_3_l_f(u)
    elif 0.6 < u <= 0.8:
        res = c[3] * psi_3_r_f(u) + c[4] * psi_4_l_f(u)
    elif 0.8 < u <= 1.0:
        res = c[4] * psi_4_r_f(u) + c[5] * psi_5_l_f(u)
    elif 1.0 < u <= 1.2:
        res = c[5] * psi_5_r_f(u)
    return res
...
if __name__ == "__main__":
    ...
    test_data_name = 'N_400_example_4_mul_test_big'
