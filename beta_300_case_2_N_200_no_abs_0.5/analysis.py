...
def plot_fixed_time_difference():
    ...
    time_step = 8  # 5
    example_index = 0
    test_data_name = 'beta_300_case_2_N_200_0.5'
    data_0_file = 'data/beta_300_case_1_N_200_0.5_without_diff_U.npy'
    data_10_file = 'data/beta_300_case_2_N_200_0.5_U.npy'
    time_steps_0 = [0, 11, 23, 34, 45, 57, 68, 79, 91, 102]
    time_steps_10 = [0, 45, 91, 136, 182, 227, 273, 318, 364, 409]
    ...
    if not os.path.isdir(save_dir):
        os.mkdir(save_dir)
    file_name = '/exam_' + str(example_index) + '_time_' + str(time_step * 0.1) + '_a2' + '.pdf'
    fig.savefig(save_dir + file_name, bbox_inches='tight', pad_inches=0.5)
