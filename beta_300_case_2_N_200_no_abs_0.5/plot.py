...
def a_predict_function(u):
    if u <= 0.25:
        y = (0.09175786292197967)*u+(-0.021807865265482652)*1
    elif u > 0.25 and u < 0.5:
        y = (-0.10461771181855767)*u+(0.037519644709899325)*1
    elif u >= 0.5 and u < 0.75:
        y = (0.6963932156214532)*u+(-0.3468875313789374)*1
    else:
        y = (-0.38830850126116734)*u+(0.0342355687619051)*1
    return np.abs(y)
...
if __name__ == "__main__":
    ...
    test_data_name = 'beta_300_case_2_N_200_0.5_obs_1'
