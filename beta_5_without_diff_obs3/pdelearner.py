...
class VariantCoeLinear1d(torch.nn.Module):
    ...
    def update(self):
        ...
        if max_f_prime > 0 and max_f_prime < 100.0:
...
def generate_real_data(save_file, u0_file, u_fixed_file, x0_file):
    device = 'cpu'
    T = 2   # 40
    X = 10
    dt = 0.08
    ...
    u_0_np[3:4, 0:100] = 0.3  # 0.3
    u_0_np[3:4, 180:400] = 0.3  # 0.3
    u_0_np[4:5, 100:180] = 0.85
    u_0_np[4:5, 0:100] = 0.3  #  0.3
    u_0_np[4:5, 180:400] = 0.3  #  0.3
    u_0 = torch.from_numpy(u_0_np)
    u_0 = u_0.to(device)
...
if __name__ == "__main__":
    experiment_name = 'beta_5_case_3_N_200_0.0'
    ...
    generate_real_data(real_data_file, u0_file, u_fixed_file, x0_file)
