...
def f_predict_function(u):
    ...
    # a = (-36.072504031812365)*u**3+(29.528189481418345)*u**4+(26.209798111219712)*u**2+(19.659299972387878)*u**5+(-4.558061370752295)*u+(1.9887462185024305)*u**6+(-1.0173310278132939)*1+(-0.1003895757169248)*u**7+(0.0010514484516247606)*u**8
    # b = (-42.86265927292863)*u**3+(36.97897982336799)*u**2+(36.312302713058386)*u**4+(24.197465303463968)*u**5+(-18.885448149405477)*u+(5.74579337220487)*1+(2.4478296626633456)*u**6+(-0.12356356933622303)*u**7+(0.0012941654821029087)*u**8
    return a/b
...
if __name__ == "__main__":
    ...
    test_data_name = 'beta_5_case_3_N_200_0.0'
    ...
    predict_data_file = 'data/' + test_data_name + '_U' + '.npy'

    real_time_step = 418    # 168(1.5)   # 223 (2.0)
    predict_time_step = 418   # 165(1.5)   # 219 (2.0)
    time = 15
    example_index = 0
