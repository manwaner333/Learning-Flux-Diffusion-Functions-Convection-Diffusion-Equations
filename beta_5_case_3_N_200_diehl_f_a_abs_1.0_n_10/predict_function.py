...
class VariantCoeLinear1d(torch.nn.Module):
    ...
    def f_real(self, u):
        c =[-0.4800, -0.5425, -0.6473, -0.5758, -0.2407,  0.1356,  0.3648,  0.4800,
          0.5005,  0.5182,  0.5166]
    ...
    def a_real(self, u):
        ...
        c = [6.3749e-03, -1.0880e-02,  3.7935e-02,  1.4449e-02, -4.2428e-03, 4.9939e-04,  7.6026e-02,  7.8110e-02,  3.9740e-01, -5.1474e-01, -4.5020e-01]
    ...
    #
    # def a_real_1(self, u):
    #     a = (0.2014767903916422) * u + (-0.013874930559963795) * 1
    #     return torch.abs(a).double()
    #
    # def a_real_2(self, u):
    #     a = (0.011285074856649997) * u + (-0.002874770098300333) * 1
    #     return torch.abs(a).double()
    #
    # def a_real_3(self, u):
    #     a = (0.6812851706969618) * u + (-0.3430319888320075) * 1
    #     return torch.abs(a).double()
    #
    # def a_real_4(self, u):
    #     a = (0.3098241836785081) * 1 + (-0.022001436578553246) * u
    #     return torch.abs(a).double()
    #
    # def a_real(self, u):
    #     a = self.a_real_1(u) * self.u111(u) + self.a_real_2(u) * self.u222(u) + self.a_real_3(u) * self.u333(u) + self.a_real_4(u) * self.u444(u)
    #     return a.double()
...
if __name__ == "__main__":
    experiment_name = 'beta_5_case_3_N_200_1.0_diehl'
