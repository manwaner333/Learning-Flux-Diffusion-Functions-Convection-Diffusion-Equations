...
def a_predict_function(u):
    c = [ 6.3749e-03, -1.0880e-02,  3.7935e-02,  1.4449e-02, -4.2428e-03,
          4.9939e-04,  7.6026e-02,  7.8110e-02,  3.9740e-01, -5.1474e-01,
         -4.5020e-01]
    if -0.1 < u <= 0:
        res = c[0] * psi_0_l(u)
    elif 0 < u <= 0.1:
...
if __name__ == "__main__":
    N = 200
    test_data_name = 'beta_5_case_3_N_200_1.0_diehl'
