...
def a_predict_function(u):
    c = [7.4528e-03, -9.9996e-04,  1.3756e-04,  1.7758e-04,  5.6341e-02,
         -1.8499e-01, -1.7969e+00,  7.5917e-01,  1.9937e+00, -5.1992e-01,
         -5.7227e-01]
    if -0.1 < u <= 0:
        res = c[0] * psi_0_l(u)
    elif 0 < u <= 0.1:
...
def f_predict_function(u):
    c = [-0.9339, -0.6803, -0.2217,  0.1471,  0.3705,  0.4566,  0.3716,  0.2744,
          0.0827,  0.1155,  0.0472]
    if -0.1 < u <= 0:
        res = c[0] * psi_0_l(u)
    elif 0 < u <= 0.1:
        res = c[0] * psi_0_r(u) + c[1] * psi_1_l(u)
...
if __name__ == "__main__":
    N = 200
    test_data_name = 'beta_300_case_1_N_200_0.5_diehl'
